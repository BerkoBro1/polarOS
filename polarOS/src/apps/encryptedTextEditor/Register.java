...
public class Register extends JPanel implements ActionListener{
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(arg0.getSource() == register && passTF.getPassword().length > 0 && userTF.getText().length() > 0) {
			...
			if(pass.equals(confirm)) {
				try {
					...
					BufferedWriter output = new BufferedWriter(new FileWriter("root\\apps\\textEditor\\passwords.txt", true));
					setHiddenAttrib(new File("root\\apps\\textEditor\\passwords.txt"));
